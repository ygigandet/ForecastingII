...
# The time interval of our time series
interval = 1439 # interval for all wednesdays
...
# Forecast just combination
fc2_chosen %>% autoplot(tslm, level = NULL) +
  guides(colour=guide_legend(title = "Models")) +
  ggtitle("Forecast bikes - Bietschhorn") +
  labs(x = "Time [10']",
       y = "Number") 
...
write_xlsx(forecast_final, "forecast_final")
```
