...
forecast_final[,2] <- subset(fc2_chosen, select = .mean)
...
forecast_final[,4] <- subset(fc2_chosen, select = .mean)
...
forecast_final[,6] <- subset(fc2_chosen, select = .mean)
...
forecast_final[,8] <- subset(fc2_chosen, select = .mean)
...
forecast_final[,10] <- subset(fc2_chosen, select = .mean)
...
forecast_final[,12] <- subset(fc2_chosen, select = .mean)
...
forecast_final[,14] <- subset(fc2_chosen, select = .mean)
...
forecast_final[,16] <- subset(fc2_chosen, select = .mean)
